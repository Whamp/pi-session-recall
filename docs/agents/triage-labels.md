...
The engineering skills use five canonical triage roles. Each role maps directly to a GitHub label.
...
When a skill names a triage role, apply the corresponding GitHub label.
