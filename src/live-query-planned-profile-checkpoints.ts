...
const LIVE_PROFILE_RESULT_SCHEMA = Type.Object({
  ...
  committedCorpus: Type.Object({
    ...
    candidatePoolRecall: Type.Number(),
    finalRecall: Type.Number(),
    contextUsefulness: Type.Number(),
    sourceOccurrencePreservation: Type.Number(),
    sessionOriginVerification: Type.Number(),
    evidenceRelationVerification: Type.Number(),
    contributingEntryVerification: Type.Number(),
    branchVerification: Type.Number(),
    policyFailureCaseIds: Type.Array(Type.String()),
    queryLatencyMilliseconds: Type.Object({
      median: Type.Number(),
      p95: Type.Number(),
    }),
    executedSearchRequests: Type.Integer({ minimum: 1 }),
    plannerRequests: Type.Integer({ minimum: 1 }),
    rerankerRequests: Type.Integer({ minimum: 1 }),
  }),
  quality: Type.Object({
    newCandidateAdmissionCount: Type.Number(),
    rankingOnlyPromotionCount: Type.Number(),
    preservedExistingSuccessCount: Type.Number(),
    noImprovementCount: Type.Number(),
