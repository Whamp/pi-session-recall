...
/** Transitional legacy-layout dependencies retained until target-format activation. */
export interface TransferLegacyIncrementalRecallWorkPlanOptions {
...
function readCurrentSessionProjections(
  options: TransferLegacyIncrementalRecallWorkPlanOptions,
...
/** Transfers legacy-layout marker work until the target generation cutover retires this runtime. */
export async function transferLegacyIncrementalRecallWorkPlan(
  options: TransferLegacyIncrementalRecallWorkPlanOptions,
