...
Generated 2026-07-25T14:03:28.078Z from corpus `recall-quality-hybrid-bounded-v2`.
...
Run duration: 8296.0 ms. Work data stayed under `.recall-data/recall-quality-evaluation/` and used only 8 checksum-fixed JSONL files.
...
| -----: | -----------------: | ----: | ----------: | -----------: | --------------: | ---------------: | ------: | ------: | ----------------: | ---- |
| 512/64 |                  8 |     5 |      100.0% |       100.0% |            5.0% |             0.0% |  100.0% |  100.0% | 71.2 ms / 76.0 ms | PASS |
| 512/64 |                 16 |     5 |      100.0% |       100.0% |            5.3% |             0.0% |  100.0% |  100.0% | 71.9 ms / 75.0 ms | PASS |
| 512/64 |                 24 |     5 |      100.0% |        90.0% |            8.1% |             0.0% |   90.0% |   90.0% | 69.6 ms / 74.4 ms | FAIL |
| 512/64 |                 32 |     5 |      100.0% |        90.0% |            9.3% |             0.0% |   90.0% |   90.0% | 70.4 ms / 73.6 ms | FAIL |
...
| --------------------------------- | ----------------------- | ---- | ----- | ------- | ------- | ----------: | ------: |
| semantic-crash-safe-outbox        | semantic_paraphrase     | hit  | hit   | useful  | 1 kept  |       12/12 | 65.2 ms |
| semantic-image-retry-budget       | semantic_paraphrase     | hit  | hit   | useful  | 1 kept  |       16/15 | 73.4 ms |
| exact-read-node-error-code        | exact_identifier        | hit  | hit   | useful  | 1 kept  |       10/10 | 70.9 ms |
| tool-evidence-lease-token         | tool_evidence           | hit  | hit   | useful  | 1 kept  |        10/8 | 71.1 ms |
| context-europe-rollout-conditions | context_dependent_reply | hit  | hit   | useful  | 1 kept  |       13/12 | 72.0 ms |
| branch-abandoned-redis-group      | branch                  | hit  | hit   | useful  | 1 kept  |       14/14 | 71.5 ms |
| branch-active-offline-queue       | branch                  | hit  | hit   | useful  | 1 kept  |       11/11 | 74.7 ms |
| branch-summary-hosted-services    | summary                 | hit  | hit   | useful  | 1 kept  |       10/10 | 70.6 ms |
| compaction-copper-finch           | summary                 | hit  | hit   | useful  | 1 kept  |       10/10 | 71.2 ms |
| duplicate-meridian-release        | duplicate_content       | hit  | hit   | useful  | 2 kept  |       14/12 | 76.0 ms |
...
- Git commit: `b8f8461f4b0dc69e360a2a27f213fc303328d667`
- Node: `v24.16.0`
- Platform: `linux/x64`
