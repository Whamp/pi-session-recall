...
| Runtime                      | native `onnxruntime-node` 1.27.0 on macOS arm64 and Linux x64 AMD; `onnxruntime-web` 1.27.0 WASM on Linux x64 Intel/unknown and macOS x64 |
